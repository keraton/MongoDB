...
mongoimport --db geodata --collection countries_basic --file  countries.json --type json --jsonArray
...
[Índice](https://github.com/AcademiaBinaria/MongoDB/blob/master/03-interaccion/03-interaccion.md) 
